...
def determine_nodes(io_server: bool,
    ...
    the number of availble processor per node (num_cpus),
    ...
    n_model_nodes = math.ceil(model_npes / num_cpus)
    ...
    if io_server:
        ...
        n_oserver_nodes = math.ceil(n_oserver_pes / num_cpus)
