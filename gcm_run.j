...
# set CICE6 initial year, month, day and sec
@CICE6 set CICE_INIT_YEAR = `echo $nymdc | cut -c1-4`
@CICE6 set CICE_INIT_MON  = `echo $nymdc | cut -c5-6`
@CICE6 set CICE_INIT_DAY  = `echo $nymdc | cut -c7-8`
@CICE6 set CICE_INIT_HOUR = `echo $nhmsc | cut -c1-2`
